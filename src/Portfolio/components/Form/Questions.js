				...
				<div className={isClicked ? "displayNone" : ""}>
					...
					<form id="form">
						...
						<div className="question">
							...
							<input className="radio-checkbox" type="checkbox" value="Funny" name="description" onChange={createSecondAnswer} selected={answers.description.includes("Funny")} />
							<label className="descriptionlabel">Funny</label>
							<br />
							<input className="radio-checkbox" type="checkbox" value="Kind" name="description" onChange={createSecondAnswer} selected={answers.description.includes("Kind")} />
							<label className="descriptionlabel">Kind</label>
							<br />
							<input className="radio-checkbox" type="checkbox" value="Smart" name="description" onChange={createSecondAnswer} selected={answers.description.includes("Smart")} />
							<label className="descriptionlabel">Smart</label>
							<br />
							<input className="radio-checkbox" type="checkbox" value="Easygoing" name="description" onChange={createSecondAnswer} selected={answers.description.includes("Easygoing")} />
